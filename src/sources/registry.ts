...
const ARTICLE: SourceTypeSchema = {
  ...
  fields: [
    ...
    { key: "authors", type: "string[]", required: false, source: "model", description: "author names in publication order" },
    { key: "site", type: "string", required: true, source: "model", description: "publication or site name" },
    { key: "publication", type: "string", required: false, source: "model", description: "journal, proceedings, or publisher name" },
    { key: "published", type: "date", required: false, source: "model", description: "publish date as YYYY-MM-DD" },
    { key: "doi", type: "string", required: false, source: "model", description: "digital object identifier, when present" },
    { key: "arxiv_id", type: "string", required: false, source: "model", description: "arXiv identifier, when present" },
    { key: "zotero_key", type: "string", required: false, source: "model", description: "Zotero item key, when present" },
    { key: "asset", type: "string", required: false, source: "derived", description: "captured local asset path" },
